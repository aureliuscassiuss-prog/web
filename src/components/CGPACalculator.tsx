...
export default function CGPACalculator() {
    ...
    const updateSemester = (id: string, field: keyof Semester, value: string) => {
        if (field === 'sgpa' && value !== '' && !isNaN(parseFloat(value)) && parseFloat(value) > 10) return
        if (field === 'credits' && value !== '' && !isNaN(parseFloat(value)) && parseFloat(value) > 50) return
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-1.5 rounded-lg text-xs font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 disabled:opacity-30 disabled:cursor-not-allowed transition-all flex items-center gap-1"
                                    >
                                        <Trash2 size={14} />
                                        Remove
                                    </button>
                    ...
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-900/20 rounded-xl flex gap-3">
                        ...
                        <div>
                            ...
                            <ul className="text-xs text-blue-800 dark:text-blue-300 leading-relaxed space-y-1">
                                ...
                                <li>•Subtract backlog credits if any</li>
