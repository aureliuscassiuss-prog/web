...
export default function PomodoroPage() {
    ...
    const switchMode = (newMode: Mode) => {
        ...
        saveModeState(mode, false, timeLeft);
            ...
            [mode]: prev[mode].map(g => {
                if (g.id === id) {
                    ...
                    if (newCompleted) {
                        ...
                        const audio = new Audio('https://assets.mixkit.co/active_storage/sfx/2000/2000-preview.mp3'); // Soft success click
                        audio.volume = 0.5;
    ...
    return (
        <div className={containerClass}>
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-start w-full max-w-5xl mx-auto px-4 pb-12 gap-8 lg:gap-16 lg:flex-row lg:items-start lg:justify-center lg:mt-8">
                ...
                {/* Right Column: Goal Manager (Always Visible) */}
