...
`}
                ...
                <div className={`mt-auto p-4 border-t border-gray-200 dark:border-gray-800 transition-opacity duration-300 ${spotlight ? 'opacity-30' : 'opacity-100'}`}>
                    <button
                        onClick={toggleTheme}
                        className="group flex w-full items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-[#1a1a1a] transition-all duration-200"
                    >
                        {/* Visual Toggle Switch (Ahead of text) */}
                        ...
                        <div className="flex items-center gap-2">
                            {/* Optional Icon could go here, but user focused on button ahead of text */}
                            {isDark ? <Moon className="w-4 h-4 text-gray-500" /> : <Sun className="w-4 h-4 text-gray-500" />}
