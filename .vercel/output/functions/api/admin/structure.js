...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            await db.collection('academic_structure').updateOne({ _id: 'main' }, updateOperation, { upsert: true });
            const updatedStructure = await db.collection('academic_structure').findOne({ _id: 'main' });
